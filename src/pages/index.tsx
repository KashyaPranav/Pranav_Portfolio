        ...
        <div className="flex flex-col space-y-6 px-5 relative h-full">
          ...
          >
            <ul className="list-disc list-inside space-y-1.5">
              <li><span className="font-bold text-white">Manager at AI Transformation, Reliance Industries Limited, Navi Mumbai</span></li>
              <li><span className="font-bold text-white">CSE graduate from SRM IST, Chennai</span><span className="font-bold text-white">, with a 9.4/10 CGPA</span></li>
