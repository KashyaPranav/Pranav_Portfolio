...
export default function MobileHome() {
  ...
  const skills = {
    ...
    devops: ['AWS', 'Docker', 'Kubernetes', 'CI/CD', 'Git', 'Linux', 'eBPF'],
    ai: ['AI/ML', 'Multi-Agent Orchestration', 'Speech Recognition', 'Computer Vision', 'LLM Agents', 'Prompt Engineering', 'RAG', 'NLP', 'Behavioral Analytics'],
  ...
  return (
    <div className="block md:hidden w-full min-h-screen bg-black text-white px-2 pb-8 flex flex-col justify-center items-center">
      <div className="flex flex-col items-center pt-6 pb-4">
        ...
        <div className="text-sm text-zinc-400 mb-2 italic text-center">
