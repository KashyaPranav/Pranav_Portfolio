...
const highlightKeywords = [
  ...
  'eye blink sequence detection',
  'neck movement recognition',
  'fingerprint sequence matching',
  'pattern recognition',
  'minutiae-based feature extraction',
  'eye blink sequence matching',
  'temporal frame analysis',
  'user-defined blink patterns',
  'spoof authentication factor',
  'real-time deep learning inference pipelines',
  'CNN',
